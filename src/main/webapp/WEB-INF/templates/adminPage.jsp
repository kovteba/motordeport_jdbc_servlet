                ...
                <div class="tab-pane fade <%=carsShow%>" id="v-pills-cars" role="tabpanel"
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="navbar">
                                    <div class="tableFlights"
                                         data-toggle="dropdown"><%=car.getCarTechnicalStatus().getCarTechnicalStatusValue()%>
                                    </div>
                                    <ul class="dropdown-menu tableFlights">
                                        <%
                                            List<CarTechnicalStatus> carTechnicalStatusList =
                                                    (List<CarTechnicalStatus>) request.getAttribute("carTechnicalStatusList");
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home"
                                               role="tab" aria-controls="home" aria-selected="true">Add car</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile"
                                               role="tab" aria-controls="profile" aria-selected="false">Add car
                                                Brand</a>
                                        </li>
                                    </ul>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <form action="createCar" method="post">
                                                    <tr>
                                                        <td style="padding: 10px">
                                                            <select name="carBrandId" required>
                                                                <option selected disabled="disabled">Choose brand
                                                                </option>
                                                                <%
                                                        ...
                                                        <td style="padding: 10px">
                                                            <select name="carClassValue" required>
                                                                <option selected disabled="disabled">Choose Class
                                                                </option>
                                                                    <%
                                                    ...
                                                    %>
                                                        ...
                                                        <td style="padding: 10px">
                                                            <select name="carTechnicalStatusValue" required>
                                                                <option selected disabled="disabled">Choose Techn Status
                                                                </option>
                                                                    <%
                                                        List<CarTechnicalStatus> carTechnicalStatusList =
                                                         (List<CarTechnicalStatus>) request.getAttribute("carTechnicalStatusList");
                                                        if (carTechnicalStatusList != null) {
                                                            for (CarTechnicalStatus carTechnicalStatus : carTechnicalStatusList) {
                                                    %>
                                                                <option value="<%=carTechnicalStatus.getCarTechnicalStatusValue()%>">
                                                                    <%=carTechnicalStatus.getCarTechnicalStatusValue()%>
                                                                </option>
                                                                    <%
                                                            }
                                                        }
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 10px">
                                                            <input type="text" placeholder="Load Capacity"
                                                                   name="loadCapacity"
                                                                   required>
                                                        </td>
                                                        <td style="padding: 10px">
