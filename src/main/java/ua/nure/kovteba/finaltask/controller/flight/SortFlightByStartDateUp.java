...
@WebServlet(
        name = "sortFlightByStartDateUp",
        urlPatterns = "/sortFlightByStartDateUp"
)
public class SortFlightByStartDateUp extends HttpServlet {

    //Create logger
    private static Logger log = Logger.getLogger(SortFlightByStartDateUp.class.getName());
